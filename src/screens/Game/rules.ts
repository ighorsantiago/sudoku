export const rules = [
    "O objetivo do jogo é claro: preencher e completar todos os quadrados da tabela com os números de 1 a 9. O desafio deste jogo está nas restrições impostas pelas regras do Sudoku sobre a forma como o jogador pode posicionar cada número.\n\n",
